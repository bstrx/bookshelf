...
use Opensoft\BookshelfBundle\Entity\Book;
use Opensoft\BookshelfBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OpensoftBookshelfBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("OpensoftBookshelfBundle:Book:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OpensoftBookshelfBundle:Book:edit.html.twig")
     */
